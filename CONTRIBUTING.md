...
2. Add the remote `upstream`:
   ...
   ```bash
   git remote add upstream https://github.com/cyb3rgh05t/streamnetvod.git
   ```
...
- If you are taking on an existing bug or feature ticket, please comment on the [issue](https://github.com/cyb3rgh05t/streamnetvod/issues) to avoid multiple people working on the same thing.
...
- If you have questions or need help, you can reach out via [Discussions](https://github.com/cyb3rgh05t/streamnetvod/discussions) or our [Discord server](https://discord.gg/overseerr).
